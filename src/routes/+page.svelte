<div class="flex flex-col-reverse h-screen p-4 bg-right-top bg-cover">
  <div class="flex flex-col">
    <div class="flex flex-row items-center gap-2 mb-3">
      <div class="rounded-full p-1 bg-green-200 text-green-900 flex justify-center items-center">
      ...
      <div class="text-2xl text-neutral-800">
        GREENY
      </div>
    </div>

    <div class="text-4xl font-black mb-2">
      Explore, Capture, Conserve
    </div>

    <div class="text-sm mb-4 font-regular">
      Capture nature's beauty through photos and build a digital encyclopedia while helping conserve our planet's biodiversity.
    </div>

    <div class="rounded-md bg-green-200 w-full h-28 mb-8 p-3 flex flex-col gap-4">
      ...
      <div class="pr-20 text-neutral-800">
        Avg Earth Surface Explored During People Lifetime
      </div>
    </div>
