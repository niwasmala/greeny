...
<div class="flex flex-col h-screen p-4">
  ...
  <div class="flex flex-row items-center justify-center gap-2 mb-8">
    <div class="rounded-full w-8 h-8 bg-green-200 text-green-900 flex justify-center items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
  ...
  <!-- <form class="space-y-6" action="#" method="POST" use:enhance> -->
    <div>
      <label for="email" class="block text-sm font-medium leading-6 text-neutral-800">Name</label>
      <div class="mt-2">
        <input id="name" name="name" type="text" value={form?.name ?? ''} class="block w-full rounded-md border-0 py-1.5 px-2 text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">
      </div>
    </div>
    ...
    <div class="py-8">
      <!-- <button type="submit" class="flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 px-2 text-sm font-semibold leading-6 text-neutral-200 shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Sign up</button> -->
      <a href="/missions" type="submit" class="flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 px-2 text-sm font-semibold leading-6 text-neutral-200 shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Sign up</a>
    </div>
  <!-- </form> -->
</div>